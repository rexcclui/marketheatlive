...
const INITIAL_STOCKS: Omit<Stock, 'history'>[] = [
  ...
  { symbol: 'TSLA', name: 'Tesla', price: 235.40, changePercent: -2.5, weeklyChangePercent: -6.8, marketCap: 750000000000, volume: 95000000, sector: 'Auto' },
  { symbol: 'META', name: 'Meta', price: 515.20, changePercent: 1.5, weeklyChangePercent: 4.2, marketCap: 1300000000000, volume: 18000000, sector: 'Tech' },
  { symbol: 'AMD', name: 'Adv Micro Dev', price: 155.10, changePercent: 3.1, weeklyChangePercent: 7.5, marketCap: 250000000000, volume: 65000000, sector: 'Tech' },
  { symbol: 'NFLX', name: 'Netflix', price: 685.00, changePercent: -0.8, weeklyChangePercent: -2.1, marketCap: 290000000000, volume: 4000000, sector: 'Media' },
  { symbol: 'INTC', name: 'Intel', price: 22.50, changePercent: -1.5, weeklyChangePercent: -4.5, marketCap: 95000000000, volume: 35000000, sector: 'Tech' },
  { symbol: 'JPM', name: 'JPMorgan', price: 210.20, changePercent: 0.4, weeklyChangePercent: 1.2, marketCap: 600000000000, volume: 9000000, sector: 'Finance' },
  { symbol: 'V', name: 'Visa', price: 285.50, changePercent: 0.1, weeklyChangePercent: 0.3, marketCap: 550000000000, volume: 6000000, sector: 'Finance' },
  { symbol: 'WMT', name: 'Walmart', price: 75.20, changePercent: 0.2, weeklyChangePercent: 1.5, marketCap: 600000000000, volume: 12000000, sector: 'Retail' },
  { symbol: 'PG', name: 'Procter & Gamble', price: 168.30, changePercent: -0.1, weeklyChangePercent: -0.5, marketCap: 400000000000, volume: 5000000, sector: 'Consumer' },
  { symbol: 'JNJ', name: 'Johnson & Johnson', price: 160.40, changePercent: -0.3, weeklyChangePercent: -1.1, marketCap: 380000000000, volume: 7000000, sector: 'Health' },
  { symbol: 'XOM', name: 'Exxon Mobil', price: 118.50, changePercent: 1.8, weeklyChangePercent: 3.2, marketCap: 500000000000, volume: 15000000, sector: 'Energy' },
  { symbol: 'CVX', name: 'Chevron', price: 155.10, changePercent: 1.2, weeklyChangePercent: 2.1, marketCap: 280000000000, volume: 8000000, sector: 'Energy' },
  { symbol: 'KO', name: 'Coca-Cola', price: 68.80, changePercent: 0.1, weeklyChangePercent: 0.2, marketCap: 290000000000, volume: 11000000, sector: 'Consumer' },
  { symbol: 'PEP', name: 'PepsiCo', price: 172.40, changePercent: -0.4, weeklyChangePercent: -0.8, marketCap: 230000000000, volume: 4500000, sector: 'Consumer' },
  { symbol: 'DIS', name: 'Disney', price: 95.30, changePercent: 0.9, weeklyChangePercent: 2.5, marketCap: 170000000000, volume: 20000000, sector: 'Media' },
];
